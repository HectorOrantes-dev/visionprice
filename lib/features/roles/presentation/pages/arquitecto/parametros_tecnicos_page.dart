...
class ArquitectoParametrosTecnicosPage extends StatefulWidget {
  final VoidCallback? onBack;
  const ArquitectoParametrosTecnicosPage({super.key, this.onBack});

  @override
  State<ArquitectoParametrosTecnicosPage> createState() => _ArquitectoParametrosTecnicosPageState();
}

class _ArquitectoParametrosTecnicosPageState extends State<ArquitectoParametrosTecnicosPage> {
  @override
