...
class IngenieroProyectosAuditadosPage extends StatefulWidget {
  final VoidCallback? onBack;
  
  const IngenieroProyectosAuditadosPage({super.key, this.onBack});

  @override
  State<IngenieroProyectosAuditadosPage> createState() => _IngenieroProyectosAuditadosPageState();
}

class _IngenieroProyectosAuditadosPageState extends State<IngenieroProyectosAuditadosPage> {
      ...
      body: Column(
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                _buildChip('Todos', isSelected: _selectedFilter == 'Todos'),
                const SizedBox(width: 8),
                _buildChip('Con anomalías', isSelected: _selectedFilter == 'Con anomalías'),
                const SizedBox(width: 8),
                _buildChip('Aprobados', isSelected: _selectedFilter == 'Aprobados'),
                const SizedBox(width: 8),
                _buildChip('En revisión', isSelected: _selectedFilter == 'En revisión'),
              ],
            ),
          ),
          const SizedBox(height: 16),
          Expanded(
            child: ListView(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              children: [
                if (_selectedFilter == 'Todos' || _selectedFilter == 'Con anomalías')
                  _buildProjectCard(
                ...
                if (_selectedFilter == 'Todos' || _selectedFilter == 'Con anomalías')
                  const SizedBox(height: 16),
                if (_selectedFilter == 'Todos' || _selectedFilter == 'Aprobados')
                  _buildProjectCard(
                ...
                if (_selectedFilter == 'Todos' || _selectedFilter == 'Aprobados')
                  const SizedBox(height: 16),
                if (_selectedFilter == 'Todos' || _selectedFilter == 'En revisión')
                  _buildProjectCard(
