                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Expanded(
                              child: Text('Costo reposición: \$11,760 MXN', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.blue)),
                            ),
                            ElevatedButton(
                              onPressed: () {},
                              ...
                              child: const Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 8),
                                  Text('Cotizar', style: TextStyle(color: Colors.white)),
                                ],
                              ),
                            ),
                          ],
