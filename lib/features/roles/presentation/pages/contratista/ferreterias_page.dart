...
class ContratistaFerreteriasPage extends StatelessWidget {
  const ContratistaFerreteriasPage({super.key});
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: Container(
                    ...
                    child: const Center(
                      child: Text('Cercanía', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                    ),
                  ),
                ),
                const Expanded(
                ...
                const Expanded(
                  child: Center(child: Text('Cobertura', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.w600))),
                ),
              ],
            ),
            const SizedBox(height: 24),
            ...
            Expanded(
              child: ListView(
                children: [
                  _buildStoreCard(
                    title: 'Grupo Constructor Juárez',
                    isStar: true,
                    badgeText: 'Cubre todo',
                    badgeColor: Colors.blue.withOpacity(0.2),
                    badgeTextColor: Colors.blue[700]!,
                    subtitle: '0.3 km · Col. Juárez',
                    borderColor: Colors.blue,
                    items: [
                      _buildListItem('Concreto premezclado f\'c 250', '\$2,100/m³', true),
                      _buildListItem('Acero #4', '\$24,800/ton', true),
                      _buildListItem('Impermeabilizante elastomérico', '\$1,250/cubeta', true),
                      _buildListItem('Drenaje PVC 4"', '\$185/pza', true),
                    ],
                    total: 'Total: \$486,200 MXN',
                  ...
                  _buildStoreCard(
                    title: 'Materiales Reforma',
                    isStar: false,
                    badgeText: 'Parcial',
                    badgeColor: Colors.orange.withOpacity(0.2),
                    badgeTextColor: Colors.orange[800]!,
                    subtitle: '0.8 km · Cuauhtémoc',
                    borderColor: Colors.grey.withOpacity(0.3),
                    items: [
                      _buildListItem('Concreto f\'c 250', '\$1,980/m³', true),
                      _buildListItem('Acero #4', '\$23,500/ton', true),
                      _buildListItem('Impermeabilizante — sin stock', null, false),
                    ],
                  ),
                ],
              ),
